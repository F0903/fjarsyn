...
use crate::media::{CodecDeviceLease, codec::backend::ffmpeg::D3d11vaDeviceContext};
    ...
    pub(super) fn init_hw_device_ctx(
        ...
        unsafe {
            ...
            if !ctx.is_null() {
                ...
                let d3d11_ctx = (*hw_ctx).hwctx as *mut D3d11vaDeviceContext;
    ...
    pub(super) fn encode_d3d11(
        ...
        unsafe {
            ...
            if device_context_ptr.is_null() {
                ...
                return Err(Error::Encode(ffmpeg::Error::InvalidData));
            }
