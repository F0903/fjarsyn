...
pub fn subscription(app: &Fjarsyn) -> Subscription<Message> {
    ...
    let call_event_subscription = call_event_subscription(app.runtime.call_event_rx.clone());

    let discovery_subscription =
        discovery_event_subscription(app.runtime.discovery_event_rx.clone());
    ...
    let messaging_subscription =
        messaging_event_subscription(app.runtime.messaging_event_rx.clone());
...
pub fn call_event_subscription(receiver: EventReceiverRef<CallEvent>) -> Subscription<Message> {
