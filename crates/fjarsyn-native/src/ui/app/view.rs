use fjarsyn_core::text::truncate;
use iced::{
...
use crate::ui::{app::AppContext, components, message::Message, subscription, theme};
    ...
    pub fn view<'a>(&'a self, _window: iced_window::Id) -> Element<'a, Message> {
        ...
        let sidebar = match self.active_screen {
            ...
            _ => {
                ...
                Some(components::sidebar(ctx, current_route, selected_peer_id))
            }
        };
